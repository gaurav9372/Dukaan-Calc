    ...
    card.innerHTML = `
      ...
      <div class="product-row">
        <div class="input-group">
          <input type="text" value="${product.price}" aria-label="Price for Product ${index + 1}" data-field="price" data-number readonly inputmode="none" />
          <span class="unit">₹</span>
        </div>
        <div class="input-group">
          <input type="text" value="${product.weight}" aria-label="Weight for Product ${index + 1}" data-field="weight" data-number readonly inputmode="none" />
