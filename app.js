    ...
    card.innerHTML = `
      ...
      <div class="product-row">
        <div class="input-group">
          <input type="text" value="${product.price}" data-field="price" data-number readonly inputmode="none" aria-label="Price" />
          <span class="unit">₹</span>
        </div>
        <div class="input-group">
          <input type="text" value="${product.weight}" data-field="weight" data-number readonly inputmode="none" aria-label="Weight" />
